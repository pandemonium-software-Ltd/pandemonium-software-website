...
// Note: Newsletter + Offers config used to live here (a per-module
// section block per the modules array). Moved to Step 3 Modules in
// May 2026 so module setup is colocated with the "I bought this"
// mental model. Same content slice keys (content.newsletter,
// content.offers) — only the mount point moved.
