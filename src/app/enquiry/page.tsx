...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch about ModuForge. Fill in the enquiry form or email me directly — I reply within 4 working hours. Oxfordshire-based, serving small businesses across the UK.",
  alternates: { canonical: "/enquiry" },
  openGraph: {
    title: "Start your enquiry — ModuForge",
    description:
      "Get in touch about ModuForge. Fill in the enquiry form or email me directly.",
